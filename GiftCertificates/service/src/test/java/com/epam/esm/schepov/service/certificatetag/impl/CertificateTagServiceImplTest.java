...
class CertificateTagServiceImplTest {
    ...
    static void setUp(){
        ...
        Mockito.doNothing().when(certificateTagDAO).deleteByCertificateId(1);
        Mockito.doThrow(new DaoException()).when(certificateTagDAO).
                deleteByCertificateId(Mockito.intThat(arg -> arg != 1));
    ...
    void insertCertificateTagDuplicateCertificateAndTagIds() {
        assertThrows(CertificateTagServiceException.class,
    ...
    void deleteByCertificateIdPositive() throws CertificateTagServiceException {
        certificateTagService.deleteByCertificateId(1);
    }

    @Test
    void deleteByCertificateIdInvalidCertificateId() {
        assertThrows(CertificateTagServiceException.class,
                () -> certificateTagService.deleteByCertificateId(5));
    }
